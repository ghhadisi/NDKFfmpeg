...
JNIEXPORT void JNICALL
Java_com_dbgs_videoaudiolib_MyPlayer_display(JNIEnv *env, jobject instance, jobject surface) {
...
JNIEXPORT void JNICALL
Java_com_dbgs_videoaudiolib_MyPlayer_release(JNIEnv *env, jobject instance) {
