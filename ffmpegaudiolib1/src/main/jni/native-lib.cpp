...
#include "libswresample/swresample.h"
    ...
    Java_com_dbgs_ffmpegaudiolib1_AudioPlayer_sound(JNIEnv *env, jobject instance, jstring input_,
                                                   jstring output_) {
...
//    反射得到Class类型
        ...
        //    反射调用createAudio
        env->CallVoidMethod(instance,createAudio,44100, out_channerl_nb);
        jmethodID audio_write = env->GetMethodID(audio_player, "playTrack", "([BI)V");
...
//                fwrite(out_buffer,1,out_buffer_size,fp_pcm);
                ...
                env->CallVoidMethod(instance, audio_write, audio_sample_array, out_buffer_size);
